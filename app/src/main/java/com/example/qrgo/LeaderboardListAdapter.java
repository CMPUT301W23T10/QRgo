...
public class LeaderboardListAdapter extends ArrayAdapter<BasicPlayerProfile> {
    public LeaderboardListAdapter(Context context, ArrayList<BasicPlayerProfile> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        scoreTextView.setText(user.getTotalScore() + "");
